...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shoutit', '0040_post_page_admin_user'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='pages_listens', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='listen',
            name='postal_code',
        ...
        migrations.AlterField(
            model_name='listen',
            name='user',
            field=models.ForeignKey(related_name='listens', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='post',
            name='page_admin_user',
        ...
        migrations.AlterUniqueTogether(
            name='listen',
            unique_together=set([('user', 'stream')]),
        ),
