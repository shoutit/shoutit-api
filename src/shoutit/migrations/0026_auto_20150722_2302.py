...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shoutit', '0025_auto_20150714_0201'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.CharField(default='', max_length=160, blank=True)),
        ...
        migrations.AlterField(
            model_name='cluser',
            name='converted_at',
            field=models.DateTimeField(null=True, verbose_name='Conversion time', blank=True),
        ),
        migrations.AlterField(
