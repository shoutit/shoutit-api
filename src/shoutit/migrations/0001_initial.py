    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.SmallIntegerField(choices=[(0, b'chat'), (1, b'about_shout')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modification time', null=True)),
                ('object_id', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('type', models.SmallIntegerField(choices=[(0, b'shout'), (1, b'location')])),
                ('content_type', models.ForeignKey(blank=True, to='contenttypes.ContentType', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Creation time', null=True)),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modification time', null=True)),
                ('streams2_ids', models.CharField(default=b'', max_length=778, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modification time', null=True)),
                ('object_id', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('text', models.TextField(default='', max_length=300, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Creation time', null=True)),
                ('modified_at', models.DateTimeField(auto_now=True, verbose_name='Modification time', null=True)),
                ('name', models.CharField(db_index=True, unique=True, max_length=30, validators=[django.core.validators.MinLengthValidator(2), django.core.validators.RegexValidator(re.compile(b'[0-9a-z-]{2,30}'), b'Enter a valid tag.', b'invalid')])),
                ('image', models.CharField(max_length=1024, null=True, blank=True)),
                ('DateCreated', models.DateTimeField(auto_now_add=True)),
                ...
                ('Stream', models.OneToOneField(related_name='tag', null=True, blank=True, to='shoutit.Stream')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('EventType', models.IntegerField(default=0, choices=[(0, b'Follow User'), (1, b'Follow Tag'), (2, b'Shout Offer'), (3, b'Shout Request'), (4, b'Experience'), (5, b'Share Experience'), (6, b'Comment'), (7, b'Post Deal'), (8, b'Buy Deal'), (9, b'Follow Business')])),
                ('content_type', models.ForeignKey(blank=True, to='contenttypes.ContentType', null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='Stream',
            field=models.ForeignKey(related_name='ShoutWraps', to='shoutit.Stream'),
        ),
        migrations.AddField(
            model_name='profile',
            name='Following',
        ...
        migrations.AddField(
            model_name='profile',
            name='Interests',
            field=models.ManyToManyField(related_name='Followers', to='shoutit.Tag'),
        ),
        migrations.AddField(
            model_name='profile',
            name='LastToken',
        ...
        migrations.AddField(
            model_name='profile',
            name='user',
            field=models.OneToOneField(related_name='profile', null=True, blank=True, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='profile',
            name='video',
        ...
        migrations.AddField(
            model_name='post',
            name='Streams',
            field=models.ManyToManyField(related_name='Posts', to='shoutit.Stream'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(related_name='Deals', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='shoutit.Item', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.OneToOneField(related_name='shout', null=True, blank=True, to='shoutit.Item')),
                ('recommended_stream', models.OneToOneField(related_name='init_shout_recommended', null=True, blank=True, to='shoutit.Stream')),
                ('related_stream', models.OneToOneField(related_name='init_shout_related', null=True, blank=True, to='shoutit.Stream')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='shoutwrap',
            name='shout',
            field=models.ForeignKey(related_name='ShoutWraps', to='shoutit.Shout'),
        ),
        migrations.AddField(
            model_name='shout',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='AboutPost',
            field=models.ForeignKey(related_name='+', to='shoutit.Trade'),
        ),
    ]
