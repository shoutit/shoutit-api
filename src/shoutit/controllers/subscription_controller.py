...
from common.constants import (SUBSCRIPE_BUSINESS, SUBSCRIPTION_TRAIL, SUBSCRIPTION_EXPIRED,
...
def SignUp(sender, **kwargs):
    if sender.custom:
        ...
        if business.Subscription:
            ...
            subscription = Subscription(Id=sender.subscr_id, type=SUBSCRIPE_BUSINESS,
                                        state=SUBSCRIPTION_TRAIL, SignUpDate=sender.subscr_date)
            subscription.save()
