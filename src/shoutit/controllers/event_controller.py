...
def register_event(user, event_type, attached_object=None):
    ...
    event = Event.objects.create(user=user, type=POST_TYPE_EVENT, EventType=event_type, attached_object=attached_object)
    user.abstract_profile.stream.add_post(event)
