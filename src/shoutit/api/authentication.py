...
from shoutit.controllers.gplus_controller import user_from_gplus_code, unlink_gplus_user, link_gplus_user
from shoutit.controllers.facebook_controller import user_from_facebook_auth_response, unlink_facebook_user, link_facebook_user
