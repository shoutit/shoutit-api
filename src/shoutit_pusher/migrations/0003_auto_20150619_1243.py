...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('shoutit_pusher', '0002_auto_20150619_1241'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(related_name='channels', through='shoutit_pusher.PusherChannelJoin', to=settings.AUTH_USER_MODEL),
        ),
