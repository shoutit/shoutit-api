...
def NotifyUserOfBadgeEarned(user, badge):
	NotifyUser(user, NOTIFICATION_TYPE_BADGE_EARNED, attached_object=badge)

def NotifyUserOfBadgeRevoked(user, badge):
	NotifyUser(user, NOTIFICATION_TYPE_BADGE_REVOKED, attached_object=badge)
