...
from apps.shoutit.models.misc import ConfirmToken, FbContest, PredefinedCity, StoredFile, SharedLocation
...
from apps.shoutit.models.message import Conversation2, Conversation2Delete, Message2, Message2Delete, Message2Read