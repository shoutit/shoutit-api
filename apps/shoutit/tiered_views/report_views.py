...
@non_cached_view(methods=['POST'],
	login_required=True,
	json_renderer = lambda request, result, *args : json_renderer(request,result,success_message='Your report was sent successfully'),
...
def report(request,type,object_id):
	...
	if type == REPORT_TYPE_USER or type == REPORT_TYPE_BUSINESS:
		...
		object_id = Base62ToInt(object_id)
