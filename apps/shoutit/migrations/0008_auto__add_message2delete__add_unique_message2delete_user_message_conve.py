...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Message2Delete'
        db.create_table(u'shoutit_message2delete', (
            ...
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deleted_set', to=orm['shoutit.Message2'])),
            ('conversation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages2_deleted_set', to=orm['shoutit.Conversation2'])),
        ))
        db.send_create_signal('shoutit', ['Message2Delete'])

        # Adding unique constraint on 'Message2Delete', fields ['user', 'message', 'conversation']
        db.create_unique(u'shoutit_message2delete', ['user_id', 'message_id', 'conversation_id'])

        # Adding model 'Message2'
        db.create_table(u'shoutit_message2', (
            ('id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['shoutit.User'])),
            ('conversation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages2', to=orm['shoutit.Conversation2'])),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True)),
        ))
        db.send_create_signal('shoutit', ['Message2'])

        # Adding model 'Conversation2Delete'
        db.create_table(u'shoutit_conversation2delete', (
            ('id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoutit.User'])),
            ('conversation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deleted_set', to=orm['shoutit.Conversation2'])),
        ))
        db.send_create_signal('shoutit', ['Conversation2Delete'])

        # Adding unique constraint on 'Conversation2Delete', fields ['user', 'conversation']
        db.create_unique(u'shoutit_conversation2delete', ['user_id', 'conversation_id'])

        # Adding model 'Message2Read'
        db.create_table(u'shoutit_message2read', (
            ('id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoutit.User'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='read_set', to=orm['shoutit.Message2'])),
            ('conversation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages2_read_set', to=orm['shoutit.Conversation2'])),
        ))
        db.send_create_signal('shoutit', ['Message2Read'])

        # Adding unique constraint on 'Message2Read', fields ['user', 'message', 'conversation']
        db.create_unique(u'shoutit_message2read', ['user_id', 'message_id', 'conversation_id'])

        # Adding model 'Conversation2'
        db.create_table(u'shoutit_conversation2', (
            ('id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
            ('object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True)),
            ('last_message', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, null=True, to=orm['shoutit.Message2'])),
        ))
        db.send_create_signal('shoutit', ['Conversation2'])

        # Adding M2M table for field users on 'Conversation2'
        m2m_table_name = db.shorten_name(u'shoutit_conversation2_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('conversation2', models.ForeignKey(orm['shoutit.conversation2'], null=False)),
            ('user', models.ForeignKey(orm['shoutit.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['conversation2_id', 'user_id'])

        # Adding field 'MessageAttachment.conversation'
        db.add_column(u'shoutit_messageattachment', 'conversation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages_attachments', to=orm['shoutit.Conversation']))


    def backwards(self, orm):
        # Removing unique constraint on 'Message2Read', fields ['user', 'message', 'conversation']
        db.delete_unique(u'shoutit_message2read', ['user_id', 'message_id', 'conversation_id'])

        # Removing unique constraint on 'Conversation2Delete', fields ['user', 'conversation']
        db.delete_unique(u'shoutit_conversation2delete', ['user_id', 'conversation_id'])

        # Removing unique constraint on 'Message2Delete', fields ['user', 'message', 'conversation']
        db.delete_unique(u'shoutit_message2delete', ['user_id', 'message_id', 'conversation_id'])

        # Deleting model 'Message2Delete'
        db.delete_table(u'shoutit_message2delete')

        # Deleting model 'Message2'
        db.delete_table(u'shoutit_message2')

        # Deleting model 'Conversation2Delete'
        db.delete_table(u'shoutit_conversation2delete')

        # Deleting model 'Message2Read'
        db.delete_table(u'shoutit_message2read')

        # Deleting model 'Conversation2'
        db.delete_table(u'shoutit_conversation2')

        # Removing M2M table for field users on 'Conversation2'
        db.delete_table(db.shorten_name(u'shoutit_conversation2_users'))

        # Deleting field 'MessageAttachment.conversation'
        db.delete_column(u'shoutit_messageattachment', 'conversation_id')
    ...
    models = {
        ...
        'shoutit.businesscreateapplication': {
            ...
            'image': ('django.db.models.fields.URLField', [], {'max_length': '1024', 'null': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'BusinessCreateApplication'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['shoutit.User']"})
        },
        ...
        'shoutit.category': {
            ...
            'Tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'Category'", 'null': 'True', 'to': "orm['shoutit.Tag']"}),
        ...
        'shoutit.conversation2': {
            ...
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'null': 'True', 'to': "orm['shoutit.Message2']"}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'shoutit.dbclconversation': {
            ...
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'in_email': ('django.db.models.fields.EmailField', [], {'max_length': '254', 'null': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'ref': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
        ...
        'shoutit.dealbuy': {
            ...
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'DealsBought'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['shoutit.User']"})
        },
        'shoutit.event': {
        ...
        'shoutit.notification': {
            'DateCreated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'FromUser': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': "orm['shoutit.User']"}),
            'IsRead': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'shoutit.profile': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'null': 'True', 'to': "orm['shoutit.User']"}),
        ...
        'shoutit.storedfile': {
            ...
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Documents'", 'null': 'True', 'to': "orm['shoutit.User']"})
        },
        'shoutit.storedimage': {
        ...
        'shoutit.tag': {
            'Creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'TagsCreated'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['shoutit.User']"}),
            'DateCreated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
