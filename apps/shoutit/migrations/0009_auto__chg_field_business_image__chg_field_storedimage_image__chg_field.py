...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.image'
        db.alter_column(u'shoutit_business', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'StoredImage.image'
        db.alter_column(u'shoutit_storedimage', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'StoredFile.File'
        db.alter_column(u'shoutit_storedfile', 'File', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Tag.image'
        db.alter_column(u'shoutit_tag', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'BusinessCreateApplication.image'
        db.alter_column(u'shoutit_businesscreateapplication', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Profile.image'
        db.alter_column(u'shoutit_profile', 'image', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'Business.image'
        db.alter_column(u'shoutit_business', 'image', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))

        # Changing field 'StoredImage.image'
        db.alter_column(u'shoutit_storedimage', 'image', self.gf('django.db.models.fields.URLField')(max_length=1024))

        # Changing field 'StoredFile.File'
        db.alter_column(u'shoutit_storedfile', 'File', self.gf('django.db.models.fields.URLField')(max_length=1024))

        # Changing field 'Tag.image'
        db.alter_column(u'shoutit_tag', 'image', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))

        # Changing field 'BusinessCreateApplication.image'
        db.alter_column(u'shoutit_businesscreateapplication', 'image', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))

        # Changing field 'Profile.image'
        db.alter_column(u'shoutit_profile', 'image', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))
