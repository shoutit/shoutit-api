...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Business.id'
        db.alter_column(u'shoutit_business', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'FbContest.id'
        db.alter_column(u'shoutit_fbcontest', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Message.id'
        db.alter_column(u'shoutit_message', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Video.id'
        db.alter_column(u'shoutit_video', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'ServiceUsage.id'
        db.alter_column(u'shoutit_serviceusage', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Report.object_id'
        db.alter_column(u'shoutit_report', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'Report.id'
        db.alter_column(u'shoutit_report', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Transaction.id'
        db.alter_column(u'shoutit_transaction', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Currency.id'
        db.alter_column(u'shoutit_currency', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'StoredImage.id'
        db.alter_column(u'shoutit_storedimage', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Category.id'
        db.alter_column(u'shoutit_category', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'DealBuy.id'
        db.alter_column(u'shoutit_dealbuy', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'BusinessConfirmation.id'
        db.alter_column(u'shoutit_businessconfirmation', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Stream2.id'
        db.alter_column(u'shoutit_stream2', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Stream2.object_id'
        db.alter_column(u'shoutit_stream2', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'Subscription.id'
        db.alter_column(u'shoutit_subscription', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Notification.object_id'
        db.alter_column(u'shoutit_notification', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'Notification.id'
        db.alter_column(u'shoutit_notification', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'StoredFile.id'
        db.alter_column(u'shoutit_storedfile', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Tag.id'
        db.alter_column(u'shoutit_tag', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Payment.object_id'
        db.alter_column(u'shoutit_payment', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'Payment.id'
        db.alter_column(u'shoutit_payment', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'BusinessSource.id'
        db.alter_column(u'shoutit_businesssource', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Comment.id'
        db.alter_column(u'shoutit_comment', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'PredefinedCity.id'
        db.alter_column(u'shoutit_predefinedcity', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Post.id'
        db.alter_column(u'shoutit_post', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'GalleryItem.id'
        db.alter_column(u'shoutit_galleryitem', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Event.object_id'
        db.alter_column(u'shoutit_event', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'BusinessCreateApplication.id'
        db.alter_column(u'shoutit_businesscreateapplication', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'BusinessCategory.id'
        db.alter_column(u'shoutit_businesscategory', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'LinkedGoogleAccount.id'
        db.alter_column(u'shoutit_linkedgoogleaccount', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'LinkedFacebookAccount.id'
        db.alter_column(u'shoutit_linkedfacebookaccount', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'MessageAttachment.id'
        db.alter_column(u'shoutit_messageattachment', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'MessageAttachment.object_id'
        db.alter_column(u'shoutit_messageattachment', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=32, null=True))

        # Changing field 'Item.id'
        db.alter_column(u'shoutit_item', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Listen.id'
        db.alter_column(u'shoutit_listen', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Stream.id'
        db.alter_column(u'shoutit_stream', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Gallery.id'
        db.alter_column(u'shoutit_gallery', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Service.id'
        db.alter_column(u'shoutit_service', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'ConfirmToken.id'
        db.alter_column(u'shoutit_confirmtoken', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'FollowShip.id'
        db.alter_column(u'shoutit_followship', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Profile.id'
        db.alter_column(u'shoutit_profile', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'User.id'
        db.alter_column(u'shoutit_user', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'UserPermission.id'
        db.alter_column(u'shoutit_userpermission', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'ServiceBuy.id'
        db.alter_column(u'shoutit_servicebuy', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'ShoutWrap.id'
        db.alter_column(u'shoutit_shoutwrap', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Voucher.id'
        db.alter_column(u'shoutit_voucher', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'SharedExperience.id'
        db.alter_column(u'shoutit_sharedexperience', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

        # Changing field 'Conversation.id'
        db.alter_column(u'shoutit_conversation', 'id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Business.id'
        db.alter_column(u'shoutit_business', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'FbContest.id'
        db.alter_column(u'shoutit_fbcontest', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Message.id'
        db.alter_column(u'shoutit_message', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Video.id'
        db.alter_column(u'shoutit_video', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'ServiceUsage.id'
        db.alter_column(u'shoutit_serviceusage', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Report.object_id'
        db.alter_column(u'shoutit_report', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'Report.id'
        db.alter_column(u'shoutit_report', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Transaction.id'
        db.alter_column(u'shoutit_transaction', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Currency.id'
        db.alter_column(u'shoutit_currency', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'StoredImage.id'
        db.alter_column(u'shoutit_storedimage', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Category.id'
        db.alter_column(u'shoutit_category', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'DealBuy.id'
        db.alter_column(u'shoutit_dealbuy', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'BusinessConfirmation.id'
        db.alter_column(u'shoutit_businessconfirmation', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Stream2.id'
        db.alter_column(u'shoutit_stream2', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Stream2.object_id'
        db.alter_column(u'shoutit_stream2', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'Subscription.id'
        db.alter_column(u'shoutit_subscription', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Notification.object_id'
        db.alter_column(u'shoutit_notification', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'Notification.id'
        db.alter_column(u'shoutit_notification', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'StoredFile.id'
        db.alter_column(u'shoutit_storedfile', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Tag.id'
        db.alter_column(u'shoutit_tag', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Payment.object_id'
        db.alter_column(u'shoutit_payment', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'Payment.id'
        db.alter_column(u'shoutit_payment', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'BusinessSource.id'
        db.alter_column(u'shoutit_businesssource', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Comment.id'
        db.alter_column(u'shoutit_comment', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'PredefinedCity.id'
        db.alter_column(u'shoutit_predefinedcity', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Post.id'
        db.alter_column(u'shoutit_post', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'GalleryItem.id'
        db.alter_column(u'shoutit_galleryitem', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Event.object_id'
        db.alter_column(u'shoutit_event', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'BusinessCreateApplication.id'
        db.alter_column(u'shoutit_businesscreateapplication', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'BusinessCategory.id'
        db.alter_column(u'shoutit_businesscategory', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'LinkedGoogleAccount.id'
        db.alter_column(u'shoutit_linkedgoogleaccount', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'LinkedFacebookAccount.id'
        db.alter_column(u'shoutit_linkedfacebookaccount', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'MessageAttachment.id'
        db.alter_column(u'shoutit_messageattachment', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'MessageAttachment.object_id'
        db.alter_column(u'shoutit_messageattachment', 'object_id', self.gf('uuidfield.fields.UUIDField')(max_length=36, null=True))

        # Changing field 'Item.id'
        db.alter_column(u'shoutit_item', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Listen.id'
        db.alter_column(u'shoutit_listen', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Stream.id'
        db.alter_column(u'shoutit_stream', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Gallery.id'
        db.alter_column(u'shoutit_gallery', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Service.id'
        db.alter_column(u'shoutit_service', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'ConfirmToken.id'
        db.alter_column(u'shoutit_confirmtoken', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'FollowShip.id'
        db.alter_column(u'shoutit_followship', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Profile.id'
        db.alter_column(u'shoutit_profile', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'User.id'
        db.alter_column(u'shoutit_user', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'UserPermission.id'
        db.alter_column(u'shoutit_userpermission', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'ServiceBuy.id'
        db.alter_column(u'shoutit_servicebuy', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'ShoutWrap.id'
        db.alter_column(u'shoutit_shoutwrap', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Voucher.id'
        db.alter_column(u'shoutit_voucher', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'SharedExperience.id'
        db.alter_column(u'shoutit_sharedexperience', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))

        # Changing field 'Conversation.id'
        db.alter_column(u'shoutit_conversation', 'id', self.gf('uuidfield.fields.UUIDField')(max_length=36, unique=True, primary_key=True))
