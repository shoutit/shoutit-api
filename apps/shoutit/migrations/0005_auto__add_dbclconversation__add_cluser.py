...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DBCLConversation'
        db.create_table(u'shoutit_dbclconversation', (
            ...
            ('in_email', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['shoutit.User'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['shoutit.User'])),
            ('shout', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoutit.Trade'])),
            ('ref', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ))
        db.send_create_signal('shoutit', ['DBCLConversation'])

        # Adding model 'CLUser'
        db.create_table(u'shoutit_cluser', (
            ('id', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='cluser', unique=True, to=orm['shoutit.User'])),
            ('cl_email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
        ))
        db.send_create_signal('shoutit', ['CLUser'])


    def backwards(self, orm):
        # Deleting model 'DBCLConversation'
        db.delete_table(u'shoutit_dbclconversation')

        # Deleting model 'CLUser'
        db.delete_table(u'shoutit_cluser')
