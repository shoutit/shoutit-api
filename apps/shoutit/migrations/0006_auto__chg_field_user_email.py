...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Profile.Image'
        db.rename_column(u'shoutit_profile', 'Image', 'image')

        # Renaming field 'Business.Image'
        db.rename_column(u'shoutit_business', 'Image', 'image')

        # Renaming field 'StoredImage.Image'
        db.rename_column(u'shoutit_storedimage', 'Image', 'image')

        # Renaming field 'Tag.Image'
        db.rename_column(u'shoutit_tag', 'Image', 'image')

        # Renaming field 'BusinessCreateApplication.Image'
        db.rename_column(u'shoutit_businesscreateapplication', 'Image', 'image')

        # Changing field 'User.email'
        db.alter_column(u'shoutit_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.email'
        db.alter_column(u'shoutit_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
