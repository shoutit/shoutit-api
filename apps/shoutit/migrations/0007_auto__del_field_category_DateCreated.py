...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Category.DateCreated'
        db.delete_column(u'shoutit_category', 'DateCreated')


    def backwards(self, orm):
        # Adding field 'Category.DateCreated'
        db.add_column(u'shoutit_category', 'DateCreated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 30, 0, 0), blank=True),
                      keep_default=False)
