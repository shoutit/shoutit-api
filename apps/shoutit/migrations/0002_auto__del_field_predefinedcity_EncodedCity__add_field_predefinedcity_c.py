...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming field 'PredefinedCity.EncodedCity'
        db.rename_column(u'shoutit_predefinedcity', 'EncodedCity', 'city_encoded')


    def backwards(self, orm):
        db.rename_column(u'shoutit_predefinedcity', 'city_encoded', 'EncodedCity')
