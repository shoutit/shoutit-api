...
ACTIVITY_TYPE_BADGE_EARNED = ActivityType('Badge Earned')
ACTIVITY_TYPE_BADGE_REVOKED = ActivityType('Badge Revoked')
...
ACTIVITY_DATA_BADGE = ActivityData('Badge')
...
NOTIFICATION_TYPE_BADGE_EARNED = NotificationType('Badge Earned')
NOTIFICATION_TYPE_BADGE_REVOKED = NotificationType('Badge Revoked')
