...
def render_notification(notification):
	...
	if notification.AttachedObject:
		...
		elif notification.Type == NOTIFICATION_TYPE_BADGE_EARNED or notification.Type == NOTIFICATION_TYPE_BADGE_REVOKED:
			result['attached_object'] = render_badge(notification.AttachedObject)
